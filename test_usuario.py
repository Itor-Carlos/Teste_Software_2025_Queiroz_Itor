...
class TestUsuario(unittest.TestCase):
    ...
    """
    Testa se a exceção do tipo ValueError é lançada quando a senha passada para função realizar_login da classe Usuario está incorreta
    """
    ...
    """
    Testa se a exceção do tipo ValueError é lançada quando o login passado para função realizar_login da classe Usuario está incorreta
    """
